...
const questions = [
  {
    ...
    options: [
      ...
      { value: "Lainnya", label: "Lainnya", inputTeks: true },
    ],
  },
  {
    id: "pintu_utama",
    ...
    options: [
      ...
      { value: "Catatan", label: "Catatan", inputTeks: true },
    ],
  },
];
...
export default function SistemPengeremanPage() {
  ...
  useEffect(() => {
    ...
    // merge foto/video dari localStorage kamera
    questions.forEach((q) => {
  ...
  // Reset input selain status ketika ganti pilihan
              ...
              <div className="p-3 space-y-3">
                {q.options.map((opt) => (
                  <div key={opt.value}>
                    ...
                    {/* Input tambahan kalau option aktif */}
        ...
        <div className="fixed bottom-0 left-0 w-full bg-gray-100 shadow-lg">
          <div className="max-w-[414px] mx-auto px-4 py-3 flex gap-3">
            ...
            <button
              ...
              onClick={() =>
                router.push("/pemeriksaan/pemeriksaanTeknis/4-kondisiBan")
              }
