                      ...
                      <div className="ml-2 mt-4">
                        ...
                        <div className="flex gap-3 mt-2">
                          ...
                          {answers[q.id]?.photo ? (
                            ...
                            <div
                              onClick={() => router.push(`/pemeriksaan/ptPenunjang/2-sistemPengereman/cameraFoto?qId=${q.id}`)}
                          ...
                          {answers[q.id]?.video ? (
                            ...
                            <div
                              onClick={() => router.push(`/pemeriksaan/ptPenunjang/2-sistemPengereman/cameraVideo?qId=${q.id}`)}
                              className="flex flex-col items-center justify-center h-24 w-full border-2 border-dashed 
                              border-[#29005E] rounded-lg bg-[#F3E9FF] cursor-pointer"
                            >
