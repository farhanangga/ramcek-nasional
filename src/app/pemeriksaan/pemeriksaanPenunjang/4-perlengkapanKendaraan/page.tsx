        ...
        <div className="fixed w-full max-w-[414px] z-50">
          <div className="flex items-center justify-between bg-[#29005E] text-white px-4 py-3 shadow">
            <div className="flex items-center gap-2">
              <button onClick={() => router.push("/pemeriksaan/pemeriksaanPenunjang/3-tempatDuduk")}>
                      ...
                      <div className="ml-2 mt-4">
                        ...
                        <div className="flex gap-3 mt-2">
                          ...
                          {answers[q.id]?.photo ? (
                            ...
                            <div
                              onClick={() => router.push(`/pemeriksaan/pemeriksaanPenunjang/4-perlengkapanKendaraan/cameraFoto?qId=${q.id}`)}
                          ...
                          {answers[q.id]?.video ? (
                            ...
                            <div
                              onClick={() => router.push(`/pemeriksaan/pemeriksaanPenunjang/4-perlengkapanKendaraan/cameraVideo?qId=${q.id}`)}
                              className="flex flex-col items-center justify-center h-24 w-full border-2 border-dashed 
                                border-[#29005E] rounded-lg bg-[#F3E9FF] cursor-pointer">
          ...
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-6 text-center w-80 animate-fadeIn">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  onClick={() => router.push("/tambahTandaTangan")}
